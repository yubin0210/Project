...
<main class="frame">
	...
	<div class="search-page">
		<p>ITVING 아이디 찾기</p>
		<form method="POST">
			<p><input type="text" name="pnum" placeholder="가입된 휴대폰 번호 입력" required autofocus></p>
	...
	<c:if test="${pageContext.request.method == 'POST' }">
		...
		<c:set var="memberdto" value="${memberDAO.searchID(dto.pnum) }"/>
		<c:if test="${not empty memberdto }">
			<script>
				alert('조회된 아이디는 ${memberdto.userid} 입니다.')
